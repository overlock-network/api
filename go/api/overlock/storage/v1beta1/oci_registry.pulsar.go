...
func init() {
	...
	md_OCIRegistry = File_overlock_storage_v1beta1_oci_registry_proto.Messages().ByName("OCIRegistry")
...
func (x *OCIRegistry) slowProtoReflect() protoreflect.Message {
	mi := &file_overlock_storage_v1beta1_oci_registry_proto_msgTypes[0]
...
func (x *fastReflection_OCIRegistry) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "overlock.storage.v1beta1.OCIRegistry.creator":
		return x.Creator != ""
	...
	default:
		...
		panic(fmt.Errorf("message overlock.storage.v1beta1.OCIRegistry does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_OCIRegistry) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message overlock.storage.v1beta1.OCIRegistry does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_OCIRegistry) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "overlock.storage.v1beta1.OCIRegistry.id":
		panic(fmt.Errorf("field id of message overlock.storage.v1beta1.OCIRegistry is not mutable"))
	case "overlock.storage.v1beta1.OCIRegistry.creator":
		panic(fmt.Errorf("field creator of message overlock.storage.v1beta1.OCIRegistry is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: overlock.storage.v1beta1.OCIRegistry"))
		}
...
func (x *fastReflection_OCIRegistry) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in overlock.storage.v1beta1.OCIRegistry", d.FullName()))
	}
	panic("unreachable")
}
...
func (*OCIRegistry) Descriptor() ([]byte, []int) {
	return file_overlock_storage_v1beta1_oci_registry_proto_rawDescGZIP(), []int{0}
}
...
func (x *OCIRegistry) GetMetadata() *v1beta1.Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var File_overlock_storage_v1beta1_oci_registry_proto protoreflect.FileDescriptor

var file_overlock_storage_v1beta1_oci_registry_proto_rawDesc = []byte{
	0x0a, 0x2b, 0x6f, 0x76, 0x65, 0x72, 0x6c, 0x6f, 0x63, 0x6b, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x61,
	0x67, 0x65, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x6f, 0x63, 0x69, 0x5f, 0x72,
	0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x18, 0x6f,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x42, 0x82,
...
var (
	file_overlock_storage_v1beta1_oci_registry_proto_rawDescOnce sync.Once
	file_overlock_storage_v1beta1_oci_registry_proto_rawDescData = file_overlock_storage_v1beta1_oci_registry_proto_rawDesc
)

func file_overlock_storage_v1beta1_oci_registry_proto_rawDescGZIP() []byte {
	file_overlock_storage_v1beta1_oci_registry_proto_rawDescOnce.Do(func() {
		file_overlock_storage_v1beta1_oci_registry_proto_rawDescData = protoimpl.X.CompressGZIP(file_overlock_storage_v1beta1_oci_registry_proto_rawDescData)
	})
	return file_overlock_storage_v1beta1_oci_registry_proto_rawDescData
}
...
func init() { file_overlock_storage_v1beta1_oci_registry_proto_init() }
func file_overlock_storage_v1beta1_oci_registry_proto_init() {
	if File_overlock_storage_v1beta1_oci_registry_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_overlock_storage_v1beta1_oci_registry_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_overlock_storage_v1beta1_oci_registry_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_overlock_storage_v1beta1_oci_registry_proto_goTypes,
		DependencyIndexes: file_overlock_storage_v1beta1_oci_registry_proto_depIdxs,
		MessageInfos:      file_overlock_storage_v1beta1_oci_registry_proto_msgTypes,
	}.Build()
	File_overlock_storage_v1beta1_oci_registry_proto = out.File
	file_overlock_storage_v1beta1_oci_registry_proto_rawDesc = nil
	file_overlock_storage_v1beta1_oci_registry_proto_goTypes = nil
	file_overlock_storage_v1beta1_oci_registry_proto_depIdxs = nil
}
